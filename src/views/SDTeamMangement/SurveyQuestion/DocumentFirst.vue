      ...
      <v-card-item class="ml-15">
        <v-row dense class="mt-5">
          <v-col cols="6">
            ...
            <br />
            <h5>บริษัท เฟรเซอร์ส พร็อพเพอร์ตี้ ขอสื่อสารนโยบายการจัดซื้อจัดจ้าง</h5>
            <h5>
              อย่างรับผิดชอบ
            ...
            <h5>ในการดำเนินงานนี้ ไปยังคู่ค้าของเราต่อไป</h5>
            <br />
            <h5>
              ทางเราจึงขอให้ท่านรับทราบและศึกษานโยบายการจัดซื้อจัดจ้างอย่างรับผิดชอบนี้
            </h5>
